...
static const struct wl_seat_listener wl_seat_listener = { .capabilities = wl_seat_capabilities_handler, .name = noop };

void wl_keyboard_keymap_handler (void *userdata, struct wl_keyboard *keyboard, uint32_t format, int32_t fd,
                                 uint32_t size);
void wl_keyboard_enter_handler (void *userdata, struct wl_keyboard *keyboard, uint32_t serial,
                                struct wl_surface *surface, struct wl_array *keys);
void wl_keyboard_leave_handler (void *userdata, struct wl_keyboard *keyboard, uint32_t serial,
                                struct wl_surface *surface);
void wl_keyboard_key_handler (void *userdata, struct wl_keyboard *keyboard, uint32_t serial, uint32_t time,
                              uint32_t key, uint32_t state);
void wl_keyboard_modifiers_handler (void *userdata, struct wl_keyboard *keyboard, uint32_t serial,
